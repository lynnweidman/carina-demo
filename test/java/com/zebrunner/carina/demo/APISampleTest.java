...
public class APISampleTest implements IAbstractTest {
    ...
    public void testCreateUser() throws Exception {
        ...
        //Gets data from _post rq.json and rs.json
       ...
       // Get data from inline code
        ...
        properties.put("name", "Lynn Weidman");
        api.setProperties(properties);
        api.addProperty("company_name", "Lynn's Company");*/
    ...
    public void testCreateUserMissingSomeFields() throws Exception {
        ...
        api.getProperties().remove("zipcode");

        //Try removing company- inserts random company_name
        api.getProperties().remove("company");
